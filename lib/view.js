class View {
  ...
  gameOver() {
    ...
    const $text = $("<div><p>Game Over</p></div>");
    $text.addClass("game-over");

    const $github = $('<a href="https://github.com/chronollama"><i class="fa fa-github" aria-hidden="true"></i></a>');
    ...
    $text.append($github, $linkedin, $portfolio);
    $gameOver.append($text);
    $gameOver.append(this.restartButton());
  ...
  restartButton() {
    const $button = $("<button><p>Restart</p></button>");
